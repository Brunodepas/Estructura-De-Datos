...
public class ColaPrioridadArreglo<T extends Comparable<T>> implements Cola<T> {
    private Comparable<T>[] arreglo;
    private int elementos;
    public static final int CAPACIDAD_POR_DEFECTO = 100;


    public ColaPrioridadArreglo() {
    ...
    public boolean repOK() {
        for (int i = 0; i < elementos() - 1; i++) {
            if (arreglo[i].compareTo((T) arreglo[i + 1]) > 0) {
                return false;
            }
        }
        return true;
    ...
    public static void main(String[] args) {
        Cola<Integer> cola1 = new ColaPrioridadArreglo<>(10);
        cola1.encolar(5);
        cola1.encolar(6);
        cola1.encolar(1);
        cola1.encolar(8);
        ...
        cola1.encolar(20);
        System.out.println(cola1.toString());
        Cola<Integer> cola2 = new ColaPrioridadArreglo<>(8);
        cola2.encolar(8);
        cola2.encolar(10);
        cola2.encolar(1);
        cola2.encolar(20);
